...
public class Parser {
    ...
    public Parser(File file) {
        try {
            ...
            Simulator.exit("Assembler Error : Constructor : " + e.getMessage());
        }
    }
    ...
    public String[] nextInstruction() {
        ...
        if(line.equals(".data")){
            ...
            while (m.find()) {
                 ...
                 datasegment.data[i] = Integer.toString(n);
                 i++;
            }
    ...
    private String[] findInstruction(String[] line) {
        try {
            ...
            Simulator.exit("Assembler Error : findInstruction : " + e.getMessage());
        }

        Simulator.exit("Assembler Error : findInstruction : Invalid Instruction Found (" + line[0] + ")");
        return null;
    }
    ...
    public void jumpTo(int programCounter) {
        try {
        	...
        	Simulator.exit("Assembler Error : jumpTo : " + e.getMessage());
        }
    }
